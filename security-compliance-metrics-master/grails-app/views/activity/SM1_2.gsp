...
<br /> 
 		...
 		<p class="sh2"><b>Activity</b></p>
			...
			<p>
				...
				<input type="text" id="name" name="name" placeholder="Build support throught organization"/>
				<br/>
				
				<!-- description -->
				<br><label for="description">Description</label><br />
				<g:textArea name="description" placeholder="In order to build support for software security throughout the organization, someone in the SSG plays an evangelism role. This internal marketing function helps keep the organization current on the magnitude of the software security problem and the elements of its solution. Evangelists might give talks for internal groups, extend invitations to outside speakers, author white papers for internal consumption, or create a collection of papers, books, and other resources on an internal web site and promote its use. Ad hoc conversations between the SSG and executives or an SSG where everyone is an evangelist does not achieve the desired results. A canonical example of such an evangelist is Michael Howard's role at Microsoft." rows="5" cols="400"/>
				<br/> 

...
<br /> 
 		...
 		<p class="sh2"><b>Activity</b></p>
			...
			<p>
				...
				<input type="text" id="name" name="name" placeholder="Engage SSG with Architecture"/>
				<br/>
				
				<!-- description -->
				<br><label for="description">Description</label><br />
				<g:textArea name="description" placeholder="Security is a regular part of the organization's software architecture discussion. The architecture group takes responsibility for security the same way they take responsibility for performance, availability, or scalability. One way to keep security from falling out of the discussion is to have an SSG member attend regular architecture meetings. In other cases, enterprise architecture can help the SSG create secure designs that integrate properly into corporate design standards." rows="5" cols="400"/>
				<br/> 

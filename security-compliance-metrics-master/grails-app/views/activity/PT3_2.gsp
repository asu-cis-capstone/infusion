...
<br /> 
 		...
 		<p class="sh2"><b>Activity</b></p>
			...
			<p>
				...
				<input type="text" id="name" name="name" placeholder="Have the SSG customize penetration testing tools and scripts"/>
				<br/>
				
				<!-- description -->
				<br><label for="description">Description</label><br />
				<g:textArea name="description" placeholder="The SSG either creates penetration testing tools or adapts publicly available tools so they can more efficiently and comprehensively attack the organization's systems. Tools improve the efficiency of the penetration testing process without sacrificing the depth of problems the SSG can identify. Tools that can be tailored are always preferable to generic tools." rows="5" cols="400"/>
				<br/> 

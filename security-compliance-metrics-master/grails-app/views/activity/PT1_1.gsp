...
<br /> 
 		...
 		<p class="sh2"><b>Activity</b></p>
			...
			<p>
				...
				<input type="text" id="name" name="name" placeholder="Use external penetration testers to find problems"/>
				<br/>
				
				<!-- description -->
				<br><label for="description">Description</label><br />
				<g:textArea name="description" placeholder="Many organizations are not willing to address software security until there is unmistakable evidence that the organization is not somehow magically immune to the problem. If security has not been a priority, external penetration testers demonstrate that the organization's code needs help. Penetration testers could be brought in to break a high-profile application in order to make the point. Over time, the focus of penetration testing moves from I told you our stuff was broken to a smoke test and sanity check done before shipping. External penetration testers bring a new set of eyes to the problem." rows="5" cols="400"/>
				<br/> 

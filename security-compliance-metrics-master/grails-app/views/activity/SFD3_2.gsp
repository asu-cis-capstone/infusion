...
<br /> 
 		...
 		<p class="sh2"><b>Activity</b></p>
			...
			<p>
				...
				<input type="text" id="name" name="name" placeholder="Require use of a approved security features and frameworks"/>
				<br/>
				
				<!-- description -->
				<br><label for="description">Description</label><br />
				<g:textArea name="description" placeholder="Implementers must take their security features and frameworks from an approved list. There are two benefits: developers do not spend time re-inventing existing capabilities, and review teams do not have to contend with finding the same old defects in brand new projects. In particular, the more a project uses proven components, the easier architecture analysis and code review become. (See [AA1.1 Perform security feature review].) Re-use is a major advantage of consistent software architecture." rows="5" cols="400"/>
				<br/> 
